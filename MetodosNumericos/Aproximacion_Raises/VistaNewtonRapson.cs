...
{
    public partial class VistaNewtonRapson : Form
    {
        ...
        public VistaNewtonRapson()
        {
            InitializeComponent();
        }

        private void VistaNewtonRapson_Load(object sender, EventArgs e)
        {
        ...
        public void presicion(int decimales)
        {
            ...
            for (int i = 0; i < table.Count; i = i + 6)
            {
